...
./brewhaustd --datadir=./test1 &
./brewhaustd --datadir=./test2 &
./brewhaustd --datadir=./test3 &
./brewhaustd --datadir=./test4 &
./brewhaustd --datadir=./test5 &
./brewhaustd --datadir=./test6 &
./brewhaustd --datadir=./test7 &
