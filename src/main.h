...
static const int64_t STATIC_POS_REWARD = 1 * COIN; //Constant reward of 3.4 BRU per block has been ignored
...
static const int64_t MAX_MONEY = 25000000 * COIN; // 1M PoW coins
